...
triggermenu = [
    (
        ...
        "HLT_Ele27_eta2p1_WP75_Gsf_TriCentralPFJet30_v",
        "HLT_Ele27_eta2p1_WP75_Gsf_TriCentralPFJet50_40_30_v",
        #"HLT_Ele27_WP85_Gsf_v",

        # 14e33
        #"HLT_Ele27_eta2p1_WP85_Gsf_HT200_v",
        "HLT_Ele32_eta2p1_WP75_Gsf_CentralPFJet30_BTagCSV07_v",
        "HLT_Ele32_eta2p1_WP75_Gsf_TriCentralPFJet30_v",
        "HLT_Ele32_eta2p1_WP75_Gsf_TriCentralPFJet50_40_30_v",
        "HLT_Ele32_eta2p1_WP75_Gsf_v",  # "HLT_Ele27_eta2p1_WPLoose_Gsf_v",
...
#        # 14e33
#        #"HLT_Ele27_eta2p1_WPTight_Gsf_HT200_v",
...
#        "HLT_Ele32_eta2p1_WPLoose_Gsf_v",  # "HLT_Ele27_eta2p1_WPLoose_Gsf_v",
...
for comb in (True, False):
    for triggerpath in triggermenu:
        ...
        globals()[triggerpath[4:-3]+('_COMBO' if comb else '')] = cms.EDAnalyzer(
            "TriggerStudies",
            process_name    = cms.string('MYHLT'),
            triggerpath     = cms.string(triggerpath),
            triggerpathcomb = cms.vstring(other_trgs if comb else []),
...
for comb in (True, False):
    for triggerpath in triggermenu:
        trigStudySequence += globals()[
            triggerpath[0][4:-3]+('_COMBO' if comb else '')
        ]
